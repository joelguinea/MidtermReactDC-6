  ...
  return (
    <>
      <div className="d-flex flex-column justify-content-center align-item-center ">
        <h1 className="text-center bg-warning text-danger w-500">
        ...
        {loading && (
          <p className="text-warning bg-warning text-center">
            Loading building and schedule record 
          </p>
        )}
        <table className="table table-striped table-bordered btn btn-outline-warning">
          <thead>
            <tr>
              <th scope="col">ID</th>
        ...
        <h1
          className={
            schedule
              ? "text-center text-dark bg-warning"
              : "text-white text-dark bg-warning"
          }
        >
      ...
      <Link to="/" className="btn btn-sm btn-warning mt-1">
        <BiArrowBack />
        back
      </Link>
    </>
